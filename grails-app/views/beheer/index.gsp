...
<html>
	...
	<body>
		...
		<div id="page-body" role="main">
			...
			<g:link controller="product">Bekijk producten</g:link> (De prijs van een product wordt helaas niet verwerkt bij het het aanmaken. Bewerken van de prijs van een product werkt wel)<br/>
